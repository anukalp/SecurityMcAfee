...
public class DrawableAwesome extends Drawable {
    ...
    public DrawableAwesome(int icon, int sizeDpi, int color, boolean antiAliased, boolean fakeBold,
            float shadowRadius, float shadowDx, float shadowDy, int shadowColor, Context context) {
        super();
    ...
    public static class DrawableAwesomeBuilder {
        ...
        public DrawableAwesome build() {
            return new DrawableAwesome(icon, sizeDpi, color, antiAliased, fakeBold, shadowRadius,
                    shadowDx, shadowDy, shadowColor, context);
        }
    }
}
